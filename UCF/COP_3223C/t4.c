...
Loops
    ...
    Sometimes must use break or continue:
        ...
        Continue: will skip following code within inner most loop with continue resides, not if loop (meaning that a continue will not continue immeditealy after if loop, en)
